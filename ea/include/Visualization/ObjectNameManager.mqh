...
public:
    ...
    //| パネル背景名生成                                                   |
    //+------------------------------------------------------------------+
    string GetPanelBackgroundName() {
        return VIS_PANEL_PREFIX + "BACKGROUND";
    }

    //+------------------------------------------------------------------+
    //| パネルテキスト行名生成                                             |
    //+------------------------------------------------------------------+
    string GetPanelTextLineName(int row) {
        return VIS_PANEL_PREFIX + "TEXT_" + IntegerToString(row);
    }

    //+------------------------------------------------------------------+
    //| 全パネルObject削除                                                 |
    //+------------------------------------------------------------------+
    int DeleteAllPanelObjects(long chartId) {
